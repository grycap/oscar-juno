...
endpoint = os.getenv("OSCAR_ENDPOINT", "http://oscar.oscar.svc.cluster.local:8080")
cluster_id = os.getenv("OSCAR_CLUSTER_ID", "OSCAR")
token = os.getenv("YOUR_TOKEN", "")
token_file_path = os.getenv("TOKEN_FILE_PATH", "/token")
...
with open("client", "wb") as client_file:
    pickle.dump(client, client_file)
    print("Client saved as client.")
